...
declare module '@jcendal/objectid-lite' {
    export { ObjectId } from '@jcendal/objectid-lite/objectid';
    export type { ObjectIdOptions } from '@jcendal/objectid-lite/types';
    export { default } from '@jcendal/objectid-lite/objectid';
}

declare module '@jcendal/objectid-lite/objectid' {
    import { ObjectIdOptions } from '@jcendal/objectid-lite/types';
...
declare module '@jcendal/objectid-lite/types' {
    /**
